export const OFFER_CAMPAIGN_NAME = "Offre Boxing Center — dernières places";

/** Ton email (David), caractères GSM pour rester en SMS 7-bit. */
export const OFFER_CAMPAIGN_MESSAGE = `Salut {prenom},
